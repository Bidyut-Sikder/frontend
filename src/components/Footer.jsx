                                            ...
                                            <ul className="lab-ul office-address">
                                                {
                                                    addressList.map((item, i) => {
                                                        return (
                                                            <li key={i}><i className={item.iconName}></i>{item.text} </li>
                                                        )
                                                    })
                                                }
                                            </ul>
                                            <ul className="lab-ul social-icons">
                                                {
                                                    socialList.map((item, i) => {
                                                        return (
                                                            <li key={i}>
                                                                <a href="#" className={item.className}><i className={item.iconName}>{item.text}</i></a>
                                                            </li>
                                                        )
                                                    })
                                                }
            ...
            <div className="footer-bottom">
                <div className="container">
                    <div className="section-wrapper">
                        <p>&copy; 2024 <Link to={'/'}>Shop Cart</Link> Desinged by <a href="/" target='blank'>Bidyut</a></p>

                        <div className="footer-bottom-list">
                            {
                                footerbottomList.map((item, i) => {
                                    return (
                                        <a key={i} href='#'> {item.text}</a>
                                    )
                                })
                            }
                        </div>
